...
function Resume(props) {
     ...
     return (
        <div className="card-deck">
                        <Title>Profession Experience</Title>
        <Row className = "text-center">
            <Col size="md-12">
            <div className="aboutDtlCard">
                                    <div class="col-lg-12 card-panel grey lighten-2">
                                        ...
                                        <ul class="tech-exp">
                                            ...
                                            <li>• Application URL: https://santas-bag.herokuapp.com/
                                            </li>
                                            <li>• Github Repository: https://github.com/samergain/Santas_Bag/
                                            </li>
                    ...
                    <div className="aboutDtlCard">
                                        ...
                                        <ul class="tech-exp">
                                            ...
                                            <li>• Application URL: https://me-want-da-burger.herokuapp.com/
                                            </li>
                                            <li>• Github Repository: https://github.com/meenaambalam/Me_want_da_Burger/
                                            </li>
                                        ...
                                        <ul class="tech-exp">
                                            ...
                                            <li>• Application URL: https://meenaambalam.github.io/plan-eat-rium.io/.
                                            </li>
                                            <li>• Github Repository: https://github.com/meenaambalam/plan-eat-rium.io/
                                            </li>
                                        ...
                                        <ul class="tech-exp">
                                            ...
                                            <li>• Application URL: https://meenaambalam.github.io/Day_Scheduler/
                                            </li>
                                            <li>• Github Repository: https://github.com/meenaambalam/Day_Scheduler
                                            </li>
                                        ...
                                        <ul class="tech-exp">
                                            ...
                                            <li>• Application URL: https://meenaambalam.github.io/Weather_Dashboard/
                                            </li>
                                            <li>• Github Repository: https://github.com/meenaambalam/Weather_Dashboard
                                            </li>
