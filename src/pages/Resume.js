                    ...
                    <Col size="md-12">
                        <div className="resumeCard">
                            <div class="col-lg-12 card-panel">
                                ...
                                <ul>
                                    <li>Appreciated for completing a web project from Start to implementation single handedly.  </li>
                                    <li>Involved in Requirements Gathering, Preparing Design Brief, getting approval from Project requestor, communicating with Server Group, Developing, Testing and Implementing projects by following the KGPM (Keane Guide to Project Management) procedures.</li>
                                    <li>Was involved in multiple highly visible CSRs from requirement
                                                gathering to Implementation. </li>
                                    <li>Played main role in transition efforts of supporting Ecolab’s Intranet Website. This included meeting with the Subject-Matter-Experts, gathering requirements and information, documenting data overviews and component overviews. </li>
                                    <li>Handled 24x7 support of multiple applications. Mentored new team members on applications that I supported.</li>
                                </ul>
                            </div>
